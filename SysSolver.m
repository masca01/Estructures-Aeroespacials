...
%   - KG      Global stiffness matrix [nDof x nDof]
...
%   - R       Global reactions vector [nDof x 1]
%              R(I) - Total reaction acting on global DOF I
%--------------------------------------------------------------------------

classdef SysSolver < MainA02
    ...
    methods (Access = public)
        ...
        function [u,R] = solveSys(obj,vL,vR,uR,KG,Fext)
